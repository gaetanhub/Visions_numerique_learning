...
export const chapter1Modules: ModuleData[] = [
  ...
  },
  {
    ...
    objectifs: ['Comprendre grayscale vs RGB.', 'Distinguer nombre de canaux et profondeur en bits.'],
    prerequis: ['Matrice 2D.', 'Canal couleur.'],
    ultraSimple: ['Gris = 1 couche, couleur = 3 couches RGB.'],
    course: ['M x N en gris.', 'RGB = trois matrices M x N, une par canal.', 'Pour 8 bits par canal, taille ≈ M x N x 3 x 8 bits.'],
    figures: ['introduction_p30_fig6.jpeg','introduction_p31_fig1.jpeg','introduction_p32_fig2.jpeg','introduction_p33_fig2.jpeg'],
    aRetenir: ['En niveaux de gris, k est la profondeur en bits.', 'En RGB, il faut distinguer les 3 canaux et les bits par canal.'],
    erreursFrequentes: ['Confondre k (bits par intensité) avec le nombre de canaux couleur.'],
    flashcards: [{question:'Combien de canaux en RGB ?',answer:'3 canaux: rouge, vert, bleu.'},{question:'Que représente k dans b = M x N x k ?',answer:'Le nombre de bits utilisés pour coder l’intensité d’un pixel.'}],
    quiz: [
      {question:'Forme RGB standard ?', options:['M x N','M x N x 3','3 x M x N x 3'], answerIndex:1, feedback:'Le format usuel est hauteur x largeur x canaux.'},
